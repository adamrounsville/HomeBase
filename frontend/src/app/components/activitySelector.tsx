...
const ActivitySelector = ({ activityGroups, setActivityGroups }: props) => {
                ...
                {group.activities.map((activity, index) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger>
                          <i className="fa-solid fa-ellipsis cursor-pointer text-gray-500"></i>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent>
                          <DropdownMenuItem
                            onClick={() =>
  ...
  //                       </DropdownMenuTrigger>
  //                       <DropdownMenuContent className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
